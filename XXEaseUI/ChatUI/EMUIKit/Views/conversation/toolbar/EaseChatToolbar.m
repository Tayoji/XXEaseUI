...
//    _inputTextView.placeHolder = NSEaseLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    ...
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"EaseUIResource.bundle/voice_icon"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"EaseUIResource.bundle/voice_icon"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    ...
    self.recordButton.layer.borderWidth = 0.65;
    self.recordButton.layer.borderColor =  _inputTextView.layer.borderColor;
    ...
    */
    ...
    //分割线
//    UIView * lineView = [[UIView alloc] initWithFrame:CGRectMake(_inputTextView.frame.origin.x + 1.5, CGRectGetMaxY(_inputTextView.frame) - 0.65, _inputTextView.frame.size.width - 3, 0.65)];
//    lineView.backgroundColor = [UIColor colorWithWhite:0.8f alpha:1.0f];
//    lineView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
//    [_toolbarView insertSubview:lineView belowSubview:_inputTextView];
}
...
- (void)recordButtonTouchDown
{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(didStartRecordingVoiceAction:)]) {
        self.recordButton.backgroundColor = [UIColor colorWithRed:240.0/255 green:240.0/255 blue:240.0/255 alpha:1.0];
